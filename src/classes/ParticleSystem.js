...
class ParticleSystem {
    ...
    update() {
        ...
        while (i < this.particleCount) {
            this.particlesGeom.attributes.position.array[i * 3 + 0] += 0.05
            this.particlesGeom.attributes.position.array[i * 3 + 1] += 0.05
            this.particlesGeom.attributes.position.array[i * 3 + 2] += 0.05
            ...
            if(this.particlesGeom.attributes.position.array[i * 3 + 2] > (this.boxSize / 2)) {
                this.particlesGeom.attributes.position.array[i * 3 + 2] = - this.boxSize / 2
            }
            i++
        }
